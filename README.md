...
- 🌐 **Fast Multithreaded Subnet Scanner**:
  ...
  - Preset for **Common Web Ports** (`80, 443, 8080, 8443, 3000, 5000, 8000, ...`) or **ALL ports (1-65535)**.
  - High-throughput worker thread pool (10 to 1000 threads).
  - Instant non-blocking stop scan mechanism.
...
- 🖥️ **Separated Local Test Site Hosting (Port 8080)**:
  - One-click hosting of an embedded low-resource test web server.
  - **Dynamic Simulated RAM Allocation**: Adjust memory from `4 MB` up to `4096 MB` on the fly.
...
## 📸 Author & Contact
- **Author:** Pepper ([@piotr72181](https://www.instagram.com/piotr72181/))
- **Instagram:** [https://www.instagram.com/piotr72181/](https://www.instagram.com/piotr72181/)
- **Repository:** [https://github.com/urb3x/webscanner](https://github.com/urb3x/webscanner)
