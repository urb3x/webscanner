...
- ??? **Built-in Local Test Site (Port 8080)**:
...
### Prerequisites
- Windows 10 / 11
- Python 3.10+ (Standard Library 	kinter, urllib, socket, concurrent.futures, etc. — no external pip dependencies required to run the script)
